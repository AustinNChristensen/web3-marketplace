...
export const CoursePageModal = ({ isOpen = false }: { isOpen?: boolean}) => {
    return (
         <section>
        {/* Remove hidden to display it */}
            <div className={classNames("fixed z-10 inset-0 overflow-y-auto", !isOpen && 'hidden')} aria-labelledby="modal-title" role="dialog" aria-modal="true">
